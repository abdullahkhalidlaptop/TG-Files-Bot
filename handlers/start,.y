...
HELP_TEXT = (
    ...
    "1️⃣ Send me any file (document, video, photo or audio) — I'll store it securely.\n"
    "2️⃣ I hand you back a shareable link.\n"
    "3️⃣ Anyone who opens the link must join the required channel(s) first.\n"
    "4️⃣ Delivered files auto-delete after a timer for copyright protection.\n\n"
    "<b>Commands:</b>\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(HELP_TEXT, parse_mode="HTML", reply_markup=kb.home_kb())
